...
def check_forward(variables, with_cuda, verbose):
    ...
    if with_cuda:
        ...
        print('Forward: Baseline (py_based) vs. CUDA ... ', end='')
...
def check_backward(variables, with_cuda, verbose):
    ...
    print('Backward: Baseline (py_based) vs. C++ ... ', end='')
    ...
    if with_cuda:
        ...
        print('Backward: Baseline (py_based) vs. CUDA ... ', end='')
